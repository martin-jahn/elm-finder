...
class Migration(migrations.Migration):
    ...
    dependencies = [("package", "0001_initial")]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        help_text="Lines are broken and urls are urlized", verbose_name="Description", blank=True
                    ),
                ),
                (
                    "is_locked",
                    models.BooleanField(
                        default=False, help_text="Moderators can lock grid access", verbose_name="Is Locked"
                    ),
                ),
                (
                    "header",
