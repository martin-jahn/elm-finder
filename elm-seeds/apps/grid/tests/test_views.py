...
from apps.grid.tests import data
...
class FunctionalGridTest(TestCase):
    ...
    def test_add_grid_view(self):
        ...
        response = self.client.post(
            url, {"title": "TEST TITLE", "slug": "test-title", "description": "Just a test description"}, follow=True
        )
    ...
    def test_edit_grid_view(self):
        ...
        count = Grid.objects.count()
        response = self.client.post(
            url, {"title": "TEST TITLE", "slug": "testing", "description": "Just a test description"}, follow=True
        )
    ...
    def test_add_feature_view(self):
        ...
        # Test form post
        response = self.client.post(url, {"title": "TEST TITLE", "description": "Just a test description"}, follow=True)
    ...
    def test_edit_element_view(self):
        ...
        response = self.client.post(url, {"text": "Some random text"}, follow=True)
    ...
    def test_add_grid_package_view(self):
        ...
        response = self.client.post(url, {"package": 2})
        self.assertContains(response, "&#39;Supertester&#39; is already in this grid.")
        # Test form post for new grid package
        count = GridPackage.objects.count()
        response = self.client.post(url, {"package": 4}, follow=True)
...
class GridPermissionTest(TestCase):
    ...
    def test_add_grid_permission_success(self):
        add_grid_perm = Permission.objects.get(codename="add_grid", content_type__app_label="grid")
    ...
    def test_edit_grid_permission_success(self):
        edit_grid_perm = Permission.objects.get(codename="change_grid", content_type__app_label="grid")
...
class GridPackagePermissionTest(TestCase):
    def setUp(self):
        ...
        self.test_add_new_url = reverse("add_new_grid_package", kwargs={"grid_slug": "testing"})
    ...
    def test_add_grid_package_permission_success(self):
        add_grid_perm = Permission.objects.get(codename="add_gridpackage", content_type__app_label="grid")
        self.user.user_permissions.add(add_grid_perm)
        response = self.client.get(self.test_add_url)
        self.assertEqual(response.status_code, 200)
    ...
    def test_add_new_grid_package_permission_success(self):
        add_new_grid_perm = Permission.objects.get(codename="add_gridpackage", content_type__app_label="grid")
    ...
    def test_delete_grid_package_permission_success(self):
        delete_grid_perm = Permission.objects.get(codename="delete_gridpackage", content_type__app_label="grid")
...
class GridFeaturePermissionTest(TestCase):
    ...
    def test_add_feature_permission_success(self):
        add_feature = Permission.objects.get(codename="add_feature", content_type__app_label="grid")
    ...
    def test_edit_feature_permission_success(self):
        edit_feature = Permission.objects.get(codename="change_feature", content_type__app_label="grid")
    ...
    def test_delete_feature_permission_success(self):
        delete_feature = Permission.objects.get(codename="delete_feature", content_type__app_label="grid")
...
class GridElementPermissionTest(TestCase):
    def setUp(self):
        data.load()
        settings.RESTRICT_GRID_EDITORS = True
        self.test_edit_url = reverse("edit_element", kwargs={"feature_id": "1", "package_id": "1"})
        self.login = self.client.login(username="user", password="user")
        self.user = User.objects.get(username="user")
    ...
    def test_edit_element_permission_success(self):
        edit_element = Permission.objects.get(codename="change_element", content_type__app_label="grid")
