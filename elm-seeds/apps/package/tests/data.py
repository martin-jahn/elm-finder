...
def load():
    ...
    version, created = Version.objects.get_or_create(
        pk=2278, license="BSD License", downloads=1904, package=package6, number="2.1.3", hidden=False
    )
    version, created = Version.objects.get_or_create(
        pk=2252, license="BSD License", downloads=715, package=package6, number="2.1.2", hidden=False
    )
    version, created = Version.objects.get_or_create(
        pk=2177, license="BSD License", downloads=906, package=package6, number="2.1.1", hidden=False
    )
    version, created = Version.objects.get_or_create(
        pk=2041, license="BSD License", downloads=1613, package=package6, number="2.1.0", hidden=False
    )
    version, created = Version.objects.get_or_create(
        pk=1977, license="BSD License", downloads=850, package=package6, number="2.1.0.rc3", hidden=False
    )
    version, created = Version.objects.get_or_create(
        pk=1913, license="BSD License", downloads=726, package=package6, number="2.1.0.rc2", hidden=False
    )
    version, created = Version.objects.get_or_create(
        pk=1870, license="BSD License", downloads=299, package=package6, number="2.1.0.rc1", hidden=False
    )
    version, created = Version.objects.get_or_create(
        pk=12, license="BSD License", downloads=1062, package=package6, number="2.0.0", hidden=False
    )
    version, created = Version.objects.get_or_create(
        pk=11, license="BSD License", downloads=212, package=package6, number="2.0.1", hidden=False
    )
    version, created = Version.objects.get_or_create(
        pk=10, license="BSD License", downloads=4326, package=package6, number="2.0.2", hidden=False
    )
    version, created = Version.objects.get_or_create(
        pk=9, license="BSD License", downloads=13644, package=package6, number="2.1.0.beta3", hidden=False
    )
