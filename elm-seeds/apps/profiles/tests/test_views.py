...
from apps.core.tests.data import STOCK_PASSWORD, create_users
...
class TestProfile(TestCase):
    def setUp(self):
        ...
        self.profile = Profile.objects.create(github_account="user", user=self.user)
