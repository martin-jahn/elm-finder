        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "item_type",
                    models.CharField(
                        max_length=40, verbose_name="Item Type", choices=[("package", "Package"), ("grid", "Grid")]
                    ),
                ),
                ...
                (
                    "clean_title",
                    models.CharField(max_length="100", verbose_name="Clean title with no crud", db_index=True),
                ),
            ...
            options={"ordering": ["-weight"], "verbose_name_plural": "SearchV2s"},
            bases=(models.Model,),
        )
    ]
