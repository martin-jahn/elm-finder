...
class PackageV1Tests(TestCase):
    def setUp(self):
        ...
        """
        self.app = Category.objects.create(title="App", slug="app")
        self.framework = Category.objects.create(title="Framework", slug="framework")
        self.grid = Grid.objects.create(title="A Grid", slug="grid")
        self.pkg1 = Package.objects.create(
            title="Package1", slug="package1", category=self.app, repo_url="https://github.com/pydanny/django-uni-form"
        )
        ...
        self.pkg3 = Package.objects.create(
            title="Package3", slug="package3", category=self.framework, repo_url="https://github.com/divio/django-cms"
        )
