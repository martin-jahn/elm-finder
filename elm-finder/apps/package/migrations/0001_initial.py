...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={"ordering": ["-commit_date"], "get_latest_by": "commit_date"},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            name="Package",
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="<strong>Leave this blank if this package does not have a PyPI release.</strong> What PyPI uses to index your package. Example: django-uni-form",
                        max_length=255,
                        verbose_name="PyPI slug",
                        blank=True,
                    ),
                ),
            ...
            options={"ordering": ["title"], "get_latest_by": "id"},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            name="PackageExample",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        help_text="When this was uploaded to PyPI", null=True, verbose_name="upload_time", blank=True
                    ),
                ),
                (
                    "development_status",
