...
class FunctionalPackageTest(TestCase):
    ...
    def test_add_example_view(self):
        ...
        response = self.client.post(url, {"title": "TEST TITLE", "url": "https://github.com"})
        self.assertEqual(response.status_code, 302)
    ...
    def test_edit_example_view(self):
        ...
        url = reverse("edit_example", kwargs={"slug": e.package.slug, "id": deletable_e.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
    ...
    def test_delete_example_view(self):
        ...
        other_url = reverse("delete_example", kwargs={"slug": other_e.package.slug, "id": other_e.pk})
        noone_url = reverse("delete_example", kwargs={"slug": noone_e.package.slug, "id": noone_e.pk})
        ...
        confirm_url = reverse("confirm_delete_example", kwargs={"slug": e.package.slug, "id": e.pk})
        confirm_other_url = reverse("confirm_delete_example", kwargs={"slug": other_e.package.slug, "id": other_e.pk})
        confirm_noone_url = reverse("delete_example", kwargs={"slug": noone_e.package.slug, "id": noone_e.pk})
...
class PackagePermissionTest(TestCase):
    ...
    def test_add_package_permission_success(self):
        add_package_perm = Permission.objects.get(codename="add_package", content_type__app_label="package")
    ...
    def test_edit_package_permission_success(self):
        edit_package_perm = Permission.objects.get(codename="change_package", content_type__app_label="package")
